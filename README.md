...
### 4. Dataset: 
We use MVTec 3D-AD for our dataset (https://www.mvtec.com/company/research/datasets/mvtec-3d-ad). We also create our own dataset for missing parts detection based on MVTec 3D-AD; if you need it, please contact us. Please refer to 3D-ADS, M3DM, and Shape-guided for the data preprocessing.
